...
export function MyBrain() {
  ...
  return (
    ...
    >
      <TopBar title="My Brain" subtitle="Personal context · Live" />

      <div className="px-6 pt-4 pb-2">
        <GraphControls />
      </div>

      <div className="flex-1 relative mx-6 mb-6 rounded-2xl border border-mist overflow-hidden bg-white">
        <GraphCanvas
